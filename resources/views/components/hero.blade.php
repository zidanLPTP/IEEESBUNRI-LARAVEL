<div x-data="{ 
    ...
    <div class="absolute inset-0 z-0" aria-hidden="true">
        <img src="{{ asset('images/ini-bg.png') }}" alt="Background Gedung Universitas Riau"
            class="object-cover w-full h-full grayscale opacity-50 md:opacity-100" loading="eager" />
    ...
    <div
        class="absolute -top-[10%] -left-[20%] w-[300px] h-[300px] md:top-[-30%] md:left-[-15%] md:w-[600px] md:h-[600px] bg-[#FFE6A7] rounded-full blur-[80px] md:blur-[150px] opacity-20 z-0 animate-pulse">
    </div>
    <div
        class="absolute -bottom-[10%] -right-[20%] w-[300px] h-[300px] md:bottom-[-20%] md:right-[-10%] md:w-[600px] md:h-[600px] bg-[#214664] rounded-full blur-[80px] md:blur-[150px] opacity-30 z-0">
    </div>
    ...
    <div class="absolute left-6 md:left-12 top-1/2 -translate-y-1/2 z-20 hidden md:flex flex-col gap-8 items-center">
        ...
        <a href="https://www.linkedin.com/company/ieee-student-branch-universitas-riau" target="_blank"
            rel="noopener noreferrer" aria-label="LinkedIn IEEE SB UNRI"
            class="group relative flex items-center justify-center text-[#7AABC3] hover:text-[#E7B95A] transition-all duration-300">
            <div
                class="group-hover:-translate-y-1 group-hover:scale-110 transition-transform duration-300 drop-shadow-md">
            ...
            <span
                class="absolute left-full ml-4 px-2 py-1 bg-[#E7B95A] text-[#0C101C] text-xs font-bold rounded opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 pointer-events-none whitespace-nowrap">
                LinkedIn
                <span
                    class="absolute top-1/2 -left-1 -translate-y-1/2 border-t-[4px] border-b-[4px] border-r-[4px] border-t-transparent border-b-transparent border-r-[#E7B95A]"></span>
            </span>
        </a>

        <a href="https://www.instagram.com/ieee.sb.unri" target="_blank" rel="noopener noreferrer"
            aria-label="Instagram IEEE SB UNRI"
            class="group relative flex items-center justify-center text-[#7AABC3] hover:text-[#E7B95A] transition-all duration-300">
            <div
                class="group-hover:-translate-y-1 group-hover:scale-110 transition-transform duration-300 drop-shadow-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none"
        ...
        <button @click.prevent="copyEmail()" aria-label="Copy Email"
            class="group relative flex items-center justify-center text-[#7AABC3] hover:text-[#E7B95A] transition-all duration-300">
            <div
                class="group-hover:-translate-y-1 group-hover:scale-110 transition-transform duration-300 drop-shadow-md">
                <svg x-show="!emailCopied" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                    <rect width="20" height="16" x="2" y="4" rx="2" />
                    <path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
                </svg>

                <svg x-show="emailCopied" x-cloak xmlns="http://www.w3.org/2000/svg" width="28" height="28"
            ...
            <span
                ...
                <span :class="emailCopied ? 'border-r-green-400' : 'border-r-[#E7B95A]'"
                    class="absolute top-1/2 -left-1 -translate-y-1/2 border-t-[4px] border-b-[4px] border-r-[4px] border-t-transparent border-b-transparent"></span>
            </span>
        </button>

        <a href="https://wa.me/+6283185116094" target="_blank" rel="noopener noreferrer"
            aria-label="WhatsApp IEEE SB UNRI"
            class="group relative flex items-center justify-center text-[#7AABC3] hover:text-[#E7B95A] transition-all duration-300">
            <div
                class="group-hover:-translate-y-1 group-hover:scale-110 transition-transform duration-300 drop-shadow-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none"
    ...
    <main class="container mx-auto px-6 z-10 flex flex-col items-center text-center pt-10">
        <h1
            class="text-5xl md:text-7xl lg:text-8xl font-extrabold leading-tight text-white drop-shadow-2xl mb-6 tracking-tight">
        ...
        <h2 class="text-xl md:text-2xl text-[#7AABC3] font-light max-w-2xl mx-auto mb-4 drop-shadow-md">
            ...
            <span class="text-white font-medium">Universitas Riau Student Branch</span>
        </h2>
    ...
    <div :style="`opacity: ${Math.max(0, 1 - scroll / 300)}`"
