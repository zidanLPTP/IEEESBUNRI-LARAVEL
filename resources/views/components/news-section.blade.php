...
<section id="news" class="py-32 bg-[#0C101C] text-white overflow-hidden relative">
    ...
    <div class="absolute top-0 left-1/2 -translate-x-1/2 w-[1px] h-full bg-[#3386B7]/10 z-0 overflow-hidden" aria-hidden="true">
        <div class="absolute top-0 left-0 w-full h-[150px] bg-gradient-to-b from-transparent via-white to-transparent opacity-50 animate-shooting-news"></div>
    </div>
    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        >
            <div class="max-w-2xl">
                ...
                >
                    Latest <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#7AABC3] to-[#3386B7]">News</span>
                </h2>
            </div>
            
            <div :class="shown ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'" class="transform transition-all duration-700 delay-200 ease-out">
                <a href="{{ url('/news') }}" class="group flex items-center gap-2 text-sm font-bold text-[#7AABC3] hover:text-[#E7B95A] transition-colors">
                    View All Articles
        ...
        >
            ...
            <article 
                :class="shown ? 'opacity-100 scale-100' : 'opacity-0 scale-[0.95]'"
            ...
            >
                @if(isset($news[0]))
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-[#0C101C] via-[#0C101C]/40 to-transparent pointer-events-none" aria-hidden="true"></div>
                    
                    <div class="relative p-8 md:p-12 z-20 pointer-events-none">
                        <span class="inline-block px-3 py-1 mb-4 rounded-lg bg-[#E7B95A] text-[#0C101C] text-xs font-bold uppercase shadow-lg">
                            {{ $news[0]->category }}
                        </span>
                        <h3 class="text-3xl md:text-5xl font-bold mb-4 leading-tight group-hover:text-[#7AABC3] transition-colors line-clamp-3">
                            {{ $news[0]->title }}
                        </h3>
            ...
            <div class="lg:col-span-1 flex flex-col gap-6 h-full z-20"> 
                ...
                >
                    <a href="{{ url('/news/' . $item->slug) }}" class="absolute inset-0 z-30" aria-label="Read article: {{ $item->title }}"></a>
                ...
                >
                    ...
                    <div class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#7AABC3]"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
                    </div>
                </div>
