<x-layouts.admin>
    ...
    <div 
        x-data="galleryFormManager()" 
        class="relative w-full pb-20"
    >
        <form @submit="isSubmitting = true" action="{{ route('admin.gallery.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-7 space-y-6">
                    <div class="bg-[#151b2b] border border-white/5 rounded-3xl p-6 md:p-8 space-y-8 shadow-lg">
                        ...
                        <div>
                            <label class="text-xs font-bold text-gray-500 uppercase mb-3 block">Photo File <span class="text-red-500">*</span></label>
                            ...
                            <div class="relative aspect-video bg-[#0C101C] border-2 border-dashed border-white/10 rounded-xl hover:border-white/30 transition-colors flex flex-col items-center justify-center cursor-pointer group overflow-hidden">
                                ...
                                <template x-if="imagePreview">
                                    <img :src="imagePreview" alt="Upload" class="absolute inset-0 w-full h-full object-cover">
                                </template>
                                ...
                                <input type="file" accept="image/*" required @change="handleImageUpload" class="absolute inset-0 opacity-0 cursor-pointer">
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                <label class="text-xs font-bold text-gray-500 uppercase mb-2 block">Caption <span class="text-red-500">*</span></label>
                                <input 
                                    type="text" 
                                    name="caption"
                                    x-model="formData.caption" 
                                    required
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"><line x1="4" x2="20" y1="9" y2="9"/><line x1="4" x2="20" y1="15" y2="15"/><line x1="10" x2="8" y1="3" y2="21"/><line x1="16" x2="14" y1="3" y2="21"/></svg>
                                    <select 
                                        name="tag"
                ...
                <div class="lg:col-span-5 sticky top-28 hidden lg:block">
                    ...
                    <div class="bg-[#151b2b] border border-white/5 rounded-[2rem] overflow-hidden shadow-2xl group relative">
                        ...
                        <div class="relative aspect-video bg-[#0C101C]">
                            ...
                            <div class="absolute top-4 left-4 px-3 py-1 rounded-full text-[10px] font-bold uppercase bg-black/60 backdrop-blur text-white border border-white/10" x-text="formData.tag"></div>
                        </div>

                        <div class="p-8 relative z-10">
                            <h3 class="text-xl font-bold text-white mb-4 leading-tight" x-text="formData.caption || 'Your caption will appear here...'"></h3>
                            
                            <div class="pt-6 border-t border-white/5 flex items-center justify-between text-xs text-gray-400">
                                <div class="flex items-center gap-2">
                                    <div class="w-6 h-6 rounded-full bg-[#E7B95A] text-[#0C101C] flex items-center justify-center font-bold">
