    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('galleryFormManager', () => ({
                ...
                // Gunakan Helper Auth Laravel untuk mengambil nama secara dinamis
                // Karena kita belum aktifkan Auth, kita pakai fallback string dulu
                ...
                handleImageUpload(event) {
                    ...
                    if (file) {
                        // Validasi ukuran instan di sisi klien (Opsional tapi bagus untuk UX)
