<x-layouts.admin>
    ...
    <div x-data="newsFormManager()" class="relative w-full pb-20">
        <form @submit="isSubmitting = true" action="{{ route('admin.news.store') }}" method="POST"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <div class="bg-[#151b2b] border border-white/5 rounded-3xl p-6 md:p-8 shadow-lg">
                        ...
                        <div>
                            <label class="text-xs font-bold text-gray-500 uppercase mb-2 block">Upload Image <span
                            ...
                            <div
                                ...
                                <template x-if="!coverPreview">
                                    <div class="text-center p-4">
                                        ...
                                        <p class="text-sm text-gray-400 font-bold mb-1">Click to upload documentation
                                        </p>
                    ...
                    <div class="bg-[#151b2b] border border-white/5 rounded-3xl p-6 md:p-8 shadow-lg">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label class="text-xs font-bold text-gray-500 uppercase mb-2 block">News Category <span
                                        class="text-red-500">*</span></label>
                                <select name="category" x-model="formData.category"
                                    class="w-full bg-[#0C101C] border border-white/10 rounded-xl p-4 text-white focus:border-[#E7B95A] outline-none transition-colors appearance-none cursor-pointer">
                            ...
                            <div>
                                <label class="text-xs font-bold text-gray-500 uppercase mb-2 block">Headline Title <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div>
                                <label class="text-xs font-bold text-gray-500 uppercase mb-2 block">Main Story <span
                                        class="text-red-500">*</span></label>
                                <textarea name="content" x-model="formData.content" required rows="12"
                                    placeholder="Write the full story, achievement details, or announcement here..."
                                    class="w-full bg-[#0C101C] border border-white/10 rounded-xl p-4 text-white focus:border-[#E7B95A] outline-none text-base leading-relaxed placeholder:text-gray-700 custom-scrollbar transition-colors"></textarea>
                            </div>
                        </div>
                    </div>

                    <div
                        class="bg-[#151b2b] border border-white/5 rounded-3xl p-6 flex items-center justify-between opacity-80 shadow-lg">
                        <div class="flex items-center gap-4">
                            <div
                                class="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#E7B95A]">
                ...
                <div class="lg:col-span-5 lg:sticky lg:top-28 hidden lg:block">
                    ...
                    <div
                        ...
                        <div class="relative aspect-video bg-[#0C101C]">
                            ...
                            <div class="absolute top-4 left-4 px-3 py-1 rounded-full text-[10px] font-bold uppercase bg-[#E7B95A] text-[#0C101C] shadow-lg"
                                x-text="formData.category"></div>
                        </div>
                        ...
                        <div class="p-8 relative z-10">
                            ...
                            <h3 class="text-2xl font-bold text-white mb-4 leading-tight break-words"
                                x-text="formData.title || 'Your News Headline Will Appear Here...'"></h3>

                            <div class="text-gray-400 text-sm line-clamp-4 leading-relaxed mb-6 whitespace-pre-wrap break-words"
                                x-text="formData.content || 'The content description will be shown here. Make sure to write a compelling first paragraph to attract readers.'">
                            </div>
                            ...
                            <div class="pt-6 border-t border-white/5 flex justify-between items-center">
                                ...
                                <div
                                    class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-white group-hover:bg-[#E7B95A] group-hover:text-[#0C101C] transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="rotate-180 group-hover:rotate-0 transition-transform">
