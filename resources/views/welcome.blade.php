<x-layouts.app>
    ...
    <x-slot:metaDescription>
        Website resmi Institute of Electrical and Electronics Engineers (IEEE) Student Branch Universitas Riau. Menghadirkan kolaborasi sinergis untuk teknologi berkelanjutan.
    </x-slot:metaDescription>
